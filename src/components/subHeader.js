        ...
        <div class="dark:bg-gray-800 dark:text-gray-400 flex justify-between font-rubik bg-gray-50 md:px-10 p-2 cursor-pointer w-full h-14 fixed left-0 z-30 mt-20">
            <div class="flex mt-1">
                ...
                <div class="text-xl md:ml-0 ml-10">Category</div>
                    <div class="ml-20 dark:bg-gray-700 dark:text-gray-400 text-primaryColor bg-gray-100 px-10 rounded-full pt-1 h-8 text-center md:visible invisible">Fiction</div>
                <div>
                ...
                <div class="flex">
                    <div class="dark:bg-gray-700 flex bg-white w-28 mr-10 rounded-full px-2 h-9 md:visible invisible">
                        <img class="w-6 dark:text-gray-50" src={filterIcon} alt=""/>
