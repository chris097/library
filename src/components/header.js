...
export const Header = () => {
    return(
        <div class="bg-white shadow-sm h-20 flex justify-between md:px-10 px-2 py-4 overflow-hidden">
            <div class="flex flex-1">
                ...
                <div class="bg-gray-50 md:ml-10 md:w-2/3 w-44 md:h-12 ml-2 flex rounded-full md:px-4">
            ...
            { /** Add book button */}
            <div class="">
                <button class="dark:text-gray-300 dark:bg-gray-600 absolute right-8 flex w-40 invisible md:visible bg-primaryColor rounded-full outline-none py-3 px-5 hover:bg-blue-400 transition-all ease-in-out">
                <span class="">
                ...
                <div class="text-white font-rubik">Add Book</div>
                </button>
